...
Namespace WS_BOOK
    ...
    Partial Public Class Service1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.FDA_DROP_BOX_M27.My.MySettings.Default.FDA_DROP_BOX_WS_BOOK_Service1
        ...
        Public Function VIEW_BOOKING_HISTORY(ByVal BOX_TR_ID As Object) As System.Data.DataTable
            Dim results() As Object = Me.Invoke("VIEW_BOOKING_HISTORY", New Object() {BOX_TR_ID})
            Return CType(results(0),System.Data.DataTable)
        End Function
        
        '''<remarks/>
        Public Overloads Sub VIEW_BOOKING_HISTORYAsync(ByVal BOX_TR_ID As Object)
            Me.VIEW_BOOKING_HISTORYAsync(BOX_TR_ID, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub VIEW_BOOKING_HISTORYAsync(ByVal BOX_TR_ID As Object, ByVal userState As Object)
