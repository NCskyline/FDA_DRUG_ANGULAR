    ...
    <tr>
        <td>
            <form name="rdl_gmp">
                ...
                <input type="radio" ng-model="LIST_LCN.dalcn.PROCESS_ID" id="rdl_lcn_process" value="109" disabled="disabled">
                ผลิตยาแผนโบราณ

                <input type="radio" ng-model="LIST_LCN.dalcn.PROCESS_ID" id="rdl_lcn_process" ng-value="107"  disabled="disabled">
                ขายยาแผนโบราณ

                <input type="radio" ng-model="LIST_LCN.dalcn.PROCESS_ID" id="rdl_lcn_process" value="108"  disabled="disabled">
