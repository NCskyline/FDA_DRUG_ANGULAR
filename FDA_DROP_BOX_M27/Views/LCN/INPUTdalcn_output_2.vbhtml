            ...
            <div class="ic" ng-controller="LCN_CTRL" ng-app="ANGULAR_APP" ng-init="pageload()" ng-cloak="">
                ...
                <table style="font-size:20px;width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control inline" ng-model="LIST_LCN.dalcn.Email" style="font-family:'Taviraj';font-size:20px;" type="text" />
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table style="font-size:20px;width:100%">
                    <tr>
                        ...
                        <td style="width:10%">
                            <select class="form-control selectpicker" data-live-search="true" title="-- Please select --" ng-model="LIST_LCN.DALCN_PHR.PHR_PREFIX_ID" id="ddl_prefix1">
                                @*<option value="0">--กรุณาเลือก--</option>*@
                ...
                <table style="font-size:20px;width:100%">
                    ...
                    <tr>
                        ...
                        <td style="width:10%">
                            <select class="form-control selectpicker" data-live-search="true" title="-- Please select --" ng-model="LIST_LCN.DALCN_PHR.PHR_PREFIX_ID" id="ddl_prefix2">
                                @*<option value="0">--กรุณาเลือก--</option>*@
                ...
                <table style="font-size:20px;width:100%">
                    <tr>
                        ...
                        <td>
                            <input class="form-control inline" ng-model="LIST_LCN.DALCN_PHR.PHR_TEXT_JOB" style="font-family:'Taviraj';font-size:20px;" type="text" />
                ...
                <table style="font-size:20px;width:100%">
                    ...
                    <tr>
                        ...
                        <td style="width:20%">
                            <select class="form-control selectpicker" data-live-search="true" title="-- Please select --" ng-model="LIST_LCN.DALCN_PHR.PHR_PREFIX_ID" id="ddl_prefix3">
                                @*<option value="0">--กรุณาเลือก--</option>*@
                                <option ng-repeat="x in PREFIX" value="{{x.prefixcd}}">{{x.thanm}}</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control inline" ng-model="LIST_LCN.DALCN_PHR.PHR_CERTIFICATE_TRAINING" style="font-family:'Taviraj';font-size:20px;" type="text" />
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table style="font-size:20px;width:40%;float:right">
                    ...
                    <tr>
                        ...
                        <td style="width:50%;text-align:center">
                            <input class="form-control inline" ng-model="LIST_LCN.BSN_THAIFULLNAME" style="font-family:'Taviraj';font-size:20px;" type="text" />
                        </td>
                        <td style="text-align:left">
                            ตัวบรรจง)
                        </td>
