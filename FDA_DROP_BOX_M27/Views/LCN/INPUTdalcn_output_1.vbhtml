...
<table style=" font-size:20px;width:100%;margin-left:10%">
    ...
    <tr>
        <td>
            <input class="checkbox" type="radio" ng-model="LIST_LCN.dalcn.AGENT_COUNTRY_ID" value="2" />
        </td>
        <td>
            ขายส่ง
        </td>
    ...
    <tr>
        <td>
            <input class="checkbox" type="radio" ng-model="LIST_LCN.dalcn.AGENT_COUNTRY_ID" value="3" />
        </td>
        <td>
