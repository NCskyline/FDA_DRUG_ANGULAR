...
<div style="font-family:'Taviraj';font-size:20px;">
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <label>
                                        <input type="checkbox" ng-model="LIST_LCN.DALCN_NCT_SUBSTITUTE.REQUEST_TYPE" disabled />ใบแทนใบอนุญาต
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label><input type="checkbox" ng-model="LIST_LCN.DALCN_NCT_SUBSTITUTE.REQUEST_TYPE" disabled />ย้ายสถานที่</label>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <input type="checkbox" ng-model="LIST_LCN.LCN_TYPE" disabled />ขายยาแผนปัจจุบัน
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" ng-model="LIST_LCN.LCN_TYPE" disabled />ขายส่งยาแผนปัจจุบัน
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" ng-model="LIST_LCN.LCN_TYPE" disabled />ขายยาแผนปัจจุบันเฉพาะยาบรรจุเสร็จที่ไม่ใช่ยาอันตรายหรือยาควบคุมพิเศษ
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" ng-model="LIST_LCN.LCN_TYPE" disabled />ขายยาแผนปัจจุบันเฉพาะยาบรรจุเสร็จสำหรับสัตว์
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <table>
        <tr>
            <td><input type="checkbox" />ใบแทนใบอนุญาตขายยา</td>
            <td>เนื่องจาก</td>
            <td> <input type="text" /></td>
            <td>(ระบุเหตุที่ขอรับใบแทน)</td>
        </tr>
    </table>
    <table>
        <tr>
            <td><input type="checkbox" />ย้ายสถานที่ขายยาชื่อ</td>
            <td> <input type="text" /></td>
        </tr>
    </table>
    <table style="width:100%">
    ...
    <table style="width:100%" border="1">
        <tr>
            <td style="width:50%"><input type="checkbox" /> หลักฐานประกอบคำขอใบแทนใบอนุญาต</td>
            <td style="width:50%"><input type="checkbox" /> หลักฐานประกอบคำขอย้ายสถานที่</td>
        </tr>
    </table>
    <table style="width:100%" border="1">
        <tr>
