@Code
    ViewData("Title") = "INPUT_F_D2_198_1_UPFILE_N"
End Code
    <style>
        .tab {
            overflow: hidden;
...
<div>
    <div class="ic" style="font-family:'Taviraj'">
        <div>
            <p style="text-align: left; font-size:large"><b><u>แบบตรวจเอกสารคำขอใบอนุญาต : นิติบุคคล</u></b></p>
        </div>
        ...
        <table style="font-size:medium; width:95%" border="1" align="center">
            <tr>
                <td>
                    <p style="font-size:medium"><u>**ดาวน์โหลดแบบฟอร์มเอกสาร / ฟอร์มถ่ายรูป / แผนที่ / แผนผัง ได้ที่เว็บไซต์กองยา &rarr; &rarr; &rarr; &rarr; ข้อมูล &rarr; &rarr; &rarr; &rarr; การบริการคู่มือ &rarr; &rarr; แบบฟอร์ม / คำแนะนำ &rarr; &rarr;</u></p>
                </td>
            </tr>
        </table>
            ...
            <div id="FIRST" class="tabcontent">
                <table style="width:100%" border="1">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <b><u>เอกสารที่ผู้ขออนุญาตต้องเตรียม (นิติบุคคล)</u></b>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:10%" align="center">1.1</td>
                        <td style="width:50%">
                            แบบคำขอเปลี่ยนผู้รับอนุญาต<br />
                            (ถ้าใบอนุญาตเดิม เป็นบุคคลธรรมดา <u>ให้ผู้รับอนุญาตคนเดิม</u>ลงชื่อขอเปลี่ยนผู้รับอนุญาต)<br />
                            (ถ้าใบอนุญาตเดิม เป็นนิติบุคคล <u>ให้กรรมการ</u>ตามหนังสือรับรองบริษัทเดิม ฉบับที่ออกมาแล้วไม่เกิน 6 เดือน ลงชื่อขอเปลี่ยนผู้รับอนุญาต พร้อมแนบหนังสือรับรองดังกล่าวด้วย<br />
                            **โดยให้มีจำนวนกรรมการและประทับตราบริษัท ตามเงื่อนไขในหนังสือรับรองฯ)
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">สำเนาบัตรประชาชน (ผู้รับอนุญาตคนเดิม / กรรมการบริษัททุกคนลงนามข้อ 1.1) เซ็นต์รับรองสำเนาถูกต้อง</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:50%">สำเนาทะเบียนบ้าน (ผู้รับอนุญาตคนเดิม / กรรมการบริษัททุกคนลงนามข้อ 1.1) เซ็นต์รับรองสำเนาถูกต้อง</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:50%">ใบอนุญาต (ฉบับจริงที่ต่ออายุปีล่าสุด)</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">
                            รูปถ่ายของผู้รับอนุญาต (ผู้ดำเนินกิจการคนใหม่) ขนาด 3*4 ซม. 3 รูป<br />
                    ...
                    <tr>
                        ...
                        <td style="width:50%">สำเนาบัตรประชาชน (ผู้ดำเนินกิจการคนใหม่) เซ็นต์รับรองสำเนาถูกต้อง</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:50%">สำเนาทะเบียนบ้าน (ผู้ดำเนินกิจการคนใหม่) เซ็นต์รับรองสำเนาถูกต้อง</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">
                            สำเนาหนังสือรับรองบริษัท พร้อมแนบวัตถุประสงค์ของนิติบุคคล (ต้องมีระบุวัตถุประสงค์เกี่ยวกับการประกอบธุรกิจ / กิจการด้านยา)*****ที่ออกมาแล้วไม่เกิน 6 เดือน<br />
                            <span style="padding-left: 20px;"></span>- ต้องจดเลขที่ตั้งสถานที่ขออนุญาตในหนังสือรับรองบริษัท<br />
                            <span style="padding-left: 20px;"></span>- กรณีสถานที่<u>เก็บยาที่อยู่คนละแห่งกับสถานที่ที่ขออนุญาต</u><br />
                            <span style="padding-left: 30px;"></span><input type="checkbox" /> &nbsp; หาก<u>จดเลขที่ตั้งฯของ</u>สถานที่เก็บยา ในหนังสือรับรองบริษัทแล้ว ให้แนบเอกสารอื่นๆ ตามข้อ 1.12<br />
                            <span style="padding-left: 30px;"></span><input type="checkbox" /> &nbsp; หาก<u>ไม่ได้จดเลขที่ตั้งฯของ</u>สถานที่เก็บยา ในหนังสือรับรองบริษัท ให้แนบเอกสารอื่นๆ ตามข้อ 1.13 / 1.14 / 1.15 แล้วแต่กรณี***
                        </td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%"><b>สำเนาทะเบียนบ้านของสถานที่ที่อนุญาต และสำเนาทะเบียนบ้านของสถานที่เก็บยา (กรณี สถานที่เก็บยา)</b> อยู่คนละแห่ง<b>กับสถานที่ขออนุญาต</b></td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:50%">
                            ...
                            2.ผู้อนุญาต / ผู้ให้เช่า / ผู้ยินยอมให้ใช้สถานที่ มีชื่อเป็นผู้ซื้อในสำเนาสัญญาซื้อ-ขาย สิ่งปลูกสร้างฯ ที่ระบุเลขที่ตั้งตรงกับทะเบียนบ้าน<br />
                            3.ผู้อนุญาต / ผู้ให้เช่า / ผู้ยินยอมให้ใช้สถานที่ มีชื่อเป็นผู้ชำระค่าใช้จ่ายในใบเสร็จที่ระบุที่เก็บยา เช่น ใบเสร็จชำระค่าน้ำ / ค่าไฟ ฯลฯ<br />
                            4.กรณีเป็นบริษัทให้ยื่น สำเนาหนังสือรับรองบริษัทที่ออกมาแล้วไม่เกิน 6 เดือน <u>ของ</u>บริษัท<u>ผู้เช่า</u> หรือบริษัท<u> ผู้ยินยอมให้ใช้สถานที่</u> ที่<u>ระบุที่ตั้งตรงกับทะเบียนบ้าน</u> (เซ็นต์รับรองสำเนาทุกหน้า โดยกรรมการฯ จำนวนและประทับตราบริษัท ตามเงื่อนไขของหนังสือรับรองบริษัทนั้น)
                        </td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">
                            <b><u>กรณีเช่าสถานที่เก็บยา (ของที่ตั้งตามทะเบียนบ้านในข้อ 1.12) แนบทุกข้อ</u></b><br />
                    ...
                    <tr>
                        ...
                        <td style="width:50%">
                            <b><u>กรณผู้อื่นยินยอมให้ใช้สถานที่เป็นทีเก็บยา (ของที่ตั้งตามทะเบียนบ้านในข้อ 1.13) แนบทุกข้อ</u></b><br />
                            1.สำเนาหนังสือยินยอมให้ใช้สถานที่ หรือหนังสือฯตัวจริง<u> ลงนามโดยผู้มีกรรมสิทธิ์**</u>ในสถานที่ เซ็นต์รับรองสำเนาถูกต้องโดยผู้มีกรรมสิทธิ์ (เซ็นต์จริง)<br />
                            2.เอกสารแสดงรายชื่อผู้มีกรรมสิทธิ์** ในข้อ 1 (ให้ยื่นเอกสารอย่างใดอย่างหนึ่งในข้อ 1.13)<br />
                            3.สำเนาบัตรประชาชนของผู้มีกรรมสิทธิ์ในข้อ 1 เซ็นต์รับรองสำเนาถูกต้อง <u>(เซ็นต์จริงโดยผู้มีกรรมสิทธิ์)</u><br />
                        </td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">
                            หนังสือมอบอำนาจแต่งตั้งผู้ดำเนินกิจการ (ติดอากรแสตมป์ 30 บาท)<br />
                            (เงื่อนไข : ผู้ลงนามแต่งตั้งฯ หรือผู้มอบอำนาจฯ ต้องตรงตามเงื่อนไขในหนังสือรับรองบริษัทที่ออกมาแล้วไม่เกิน 6 เดือน*)
                        </td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">สำเนาบัตรประชาชนของผู้มอบอำนาจฯ ข้อ 1.16 และผู้รับมอบอำนาจ ข้อ 1.16 เซ็นต์รับรองสำเนาถูกต้อง</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        <td style="width:10%" align="center">1.18</td>
                        <td style="width:50%">หนังสือมอบอำนาจกระทำการแทนผู้ดำเนินกิจการ (กรณีผู้ดำเนินกิจการไม่สามารถติดต่อด้วยตนเอง) ติดอากรแสตมป์ 10 บาท</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        <td style="width:10%" align="center">1.19</td>
                        <td style="width:50%">สำเนาบัตรประชาชนของผู้มอบอำนาจในข้อ 1.18 และผู้รับมอบอำนาจในข้อ 1.18 เซ็นต์รับรองสำเนาถูกต้อง</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
            ...
            <div id="SECOND" class="tabcontent">
                <table style="width:100%" border="1">
                    ...
                    <tr>
                        ...
                        <td style="width:50%">สัญญาระหว่างเจ้าของคนใหม่ / ผู้ขออนุญาตและผู้มีหน้าที่ปฏิบัติการ จำนวน 3 ชุด</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:50%">
                            ใบรับรองแพทย์<u>ตัวจริง</u> (***จะสามารถใช้ได้ไม่เกิน 3 เดือน นับจากวันที่ระบุในใบรับรองแพทย์) พร้อมระบุ <u>5 โรคต้องห้ามเป็น</u> ของผู้รับอนุญาตเกี่ยวกับยา ดังต่อไปนี้<br />
                            <span style="padding-left: 30px;"></span>(1)&nbsp; โรคเรื้อน<br />
                            <span style="padding-left: 30px;"></span>(2)&nbsp; วัณโรคในระยะอันตราย<br />
                            <span style="padding-left: 30px;"></span>(3)&nbsp; โรคเท้าช้างในระยะปรากฏอาการเป็นที่รังเกียจแก่สังคม<br />
                            <span style="padding-left: 30px;"></span>(4)&nbsp; โรคติดยาเสพติดให้โทษอย่างร้ายแรง<br />
                    ...
                    <tr>
                        ...
                        <td style="width:50%">สำเนาหนังสือรับรองการอบรมการประชุมเชิงปฏิบัติการ หรือสำเนาใบเสร็จรับเงินเข้าร่วมการอบรม สำหรับร้านยา ขย.1 (เซ็นต์รับรองสำเนาถูกต้อง)<u> **ติดต่อสมัครที่สภาเภสัชกรรม</u></td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">สำเนาบัตรประชาชน (เซ็นต์รับรองสำเนาถูกต้อง)</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    <tr>
                        <td style="width:10%" align="center">2.9</td>
                        <td style="width:50%">สำเนาทะเบียนบ้าน (เซ็นต์รับรองสำเนาถูกต้อง)</td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width:50%">
                            ...
                            ***<u>รูปถ่าย</u>ขนาด 4*6 นิ้ว อัดกระดาษโฟโต้จากร้านอัดรูป เท่านั้น และให้ติดรูปบนแบบฟอร์มรูปถ่าย ของแต่ละประเภทใบอนุญาตให้ถูกต้อง<br />
                            ...
                            (เซ็นต์รับรองสำเนาถูกต้องโดยผู้ดำเนินกิจการ** ทุกหน้าในเอกสารทั้ง 2 รายการ)
                        </td>
                        <td style="width:20%"><input id="file-input" align="center" ng-model="FILE_DATA" type="file" name="file" ngf-select="selectFileforUpload(datas,$files)" /></td>
                        @*<td style="width:10%"></td>*@
                        <td style="width:20%"></td>
