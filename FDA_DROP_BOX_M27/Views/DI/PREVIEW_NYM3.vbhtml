        ...
        <div class="part part-2-3">
            <div class="ic">
                <div style="font-family:'Taviraj';width:100%">
                    <div>
                        <p style="text-align:right;font-size:20px">แบบ น.ย.ม.3</p>
                    </div>
                    <div class="container">
                        <div class="row" style="width:100%">
                            ...
                            <div class="title2" style="margin-left:11.5%">
                    ...
                    <table width="100%" style="font-family:'Taviraj';font-size:20px">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td width="30%"><b>เข้ามาในราชอาณาจักรเพื่อการจัดนิทรรศการ</b></td>
                    ...
                    <div style="font-size:20px;font-family:'Taviraj'">เข้ามาในราชอาณาจักรเพื่อการจัดนิทรรศการและขอรับรองว่าจะไม่นำยาทั้งหมดหรือแต่บางส่วนออก</div>
                    <div style="font-size:20px;font-family:'Taviraj'">จำหน่ายโดยเด็ดขาด พร้อมกับจะส่งหนังสือแสดงการนำหรือส่งกลับคืนให้กระทรวงสาธารณสุขทราบหรือยกให้กระทรวงสาธารณสุข ทั้งนี้ภายใน 1 เดือน นับแต่วันแสดงนิทรรศการสิ้นสุดลง</div>
                    <br />
                    ...
                    <div style="font-size:20px;font-family:'Taviraj'">3. หนังสือระบุหน่วยงาน สถานที่ และเวลาที่จะจัดนิทรรศการ</div>
                    <div style="font-size:20px;font-family:'Taviraj'">4. Certificate of Free Sale</div>
                    <br />
                    <div class="container">
                        <div class="row">
