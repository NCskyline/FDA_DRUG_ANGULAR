...
<div class="ic" ng-controller="LCN_STAFF_CTRL" ng-app="ANGULAR_APP" ng-init="Page_modify()">
    ...
    <div>
        <div class="col-sm-12" style="text-align:center">
            ...
            <input type="button" class="btn btn-lg btn-success" ng-click="BTN_LCN_EDIT_BACK()" value="ย้อนกลับ" />
