@Code ViewData("Title") = "PREVIEW_LCN_EDIT_STAFF" End Code
...
<div class="ic" ng-controller="LCN_STAFF_CTRL" ng-app="ANGULAR_APP" ng-init="Pageload_modify()">
    <div>
        ...
        <div>
            <div class="col-sm-12" style="text-align:center">
                <input type="button" class="btn btn-lg" ng-click="BTN_SEND_LCN()" style="background-color:#38A86B;color:white" value="ยื่นคำขอ" ng-disabled="" />
