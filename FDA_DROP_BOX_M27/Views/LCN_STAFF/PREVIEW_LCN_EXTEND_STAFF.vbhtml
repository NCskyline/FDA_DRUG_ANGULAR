@Code ViewData("Title") = "PREVIEW_LCN_EXTEND_STAFF" End Code

<script src="~/Scripts_angular/ANGULAR_APP.js"></script>
<script src="~/Scripts_angular/CENTER_SV.js"></script>
<script src="~/Scripts_angular/LCN_STAFF_CTRL.js"></script>

<div class="ic" ng-app="" ng-controller="LCN_STAFF_CTRL" ng-init="LoadPreviewExtend()">
    ...
    <div>
        <div class="col-sm-12" style="text-align:center">
            <input type="button" class="btn btn-lg" style="background-color:#38A86B;color:white" ng-click="BTN_SEND_EXTEND_LCN()" value="ยื่นคำขอ" ng-disabled="" />
