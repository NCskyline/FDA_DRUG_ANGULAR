...
<script src="~/Scripts_angular/MASTER_DATA_CTRL.js"></script>

<div ng-controller="" ng-app="ANGULAR_APP" ng-init="">
    <div style="font-family:'Taviraj';font-size:20px">
        ...
        <div style="text-align:center">
            <input class="btn btn-lg" type="button" value="บันทึกข้อมูล" ng-click="" />
            <input class="btn btn-lg" type="button" value="กลับหน้าหลัก" ng-click="BTN_BACK()" />
        </div>
    </div>
</div>